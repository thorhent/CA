...
1.  Primero, navega al directorio del proyecto y usa `flatpak-builder` para compilar e instalar la aplicación a partir del archivo de manifiesto:
    ...
    ```bash
    flatpak-builder --user --force-clean --install builddir/ com.github.thorhent.CA.json
    ```
...
Este proyecto está distribuido bajo la licencia [Licencia MIT](https://github.com/thorhent/clinical-ayudante/blob/main/LICENSE).
